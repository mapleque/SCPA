...
;(function(window,document){
	...
	var paint=function(a,context){
		...
		context.lineWidth=st*10;
		context.lineCap="round";
		var g=context.createLinearGradient(sp.x,sp.y,ep.x,ep.y);
		g.addColorStop(0,'rgba(200,0,0,0.9)');
		g.addColorStop(0.5,'rgba(200,100,100,0.7)');
		g.addColorStop(1,'rgba(200,100,100,0.4)');
